...
2. Всегда указывай: название(БЕЗ ID!), цену и краткое объяснение почему подходит.
...
9. Форматируй текст чтобы было красиво и наглядно видно и удобно было читать.
